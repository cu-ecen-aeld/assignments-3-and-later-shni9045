...
struct thread_data{
    ...
    int wait_to_obtain_ms;            // Member for sleep time before mutex lock
    int wait_to_release_ms;           // Member for sleep time before mutex release

    pthread_mutex_t *thread_mutex;    // Member for mutex loxk passed to created thread   
